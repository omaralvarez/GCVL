...
ELSE (APPLE)
	...
	IF (WIN32)
		...
		# TODO Search for AMD APP SDK and INTEL SDK
		#message($ENV{PROCESSOR_ARCHITECTURE})
		IF ($ENV{PROCESSOR_ARCHITECTURE} STREQUAL "AMD64" OR $ENV{PROCESSOR_ARCHITEW6432} STREQUAL "AMD64")
			#message($ENV{PROCESSOR_ARCHITEW6432})
			SET(OPENCL_LIB_DIR "$ENV{CUDA_PATH}/lib/x64")
		ELSE ($ENV{PROCESSOR_ARCHITECTURE} STREQUAL "AMD64" OR $ENV{PROCESSOR_ARCHITEW6432} STREQUAL "AMD64")
			#message("Entra  en 2 sitios")
			SET(OPENCL_LIB_DIR "$ENV{CUDA_PATH}/lib/Win32")
		ENDIF ($ENV{PROCESSOR_ARCHITECTURE} STREQUAL "AMD64" OR $ENV{PROCESSOR_ARCHITEW6432} STREQUAL "AMD64")
		#message(${OPENCL_LIB_DIR})
		FIND_LIBRARY(OPENCL_LIBRARIES OpenCL PATHS ${OPENCL_LIB_DIR} ENV OpenCL_LIBPATH NO_DEFAULT_PATH)
