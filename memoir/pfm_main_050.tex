...
\item \textbf{Optimization:} Since as of now the implemented kernels are semi-naive approaches, a careful optimization process of the CUDA and OpenCL kernels should be performed to widen the performance gap even further.
...
\end{itemize} 
%TODO Optimizacion repetido, hablar de optimizar algoritmo en el segundo