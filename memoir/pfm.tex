...
\begin{document}
	...
	\thispagestyle{empty}
        ...
        \thispagestyle{empty}     % No number page, headings...
	\include{pfm_palabras_clave}
	
	\thispagestyle{empty}
        \cleardoublepage
	
        \thispagestyle{empty}     % No number page, headings...
        \include{pfm_soft_hard}
	...
	\include{pfm_frontmatter_intro}
	\include{pfm_main_020}
	\include{pfm_main_030}
	\include{pfm_main_040}
	\include{pfm_main_050}
