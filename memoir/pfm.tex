...
\begin{document}
	...
	\thispagestyle{empty}
       % \include{tfg_resumen}
        ...
        \thispagestyle{empty}     % No number page, headings...
	%\include{tfg_palabras_clave}
	
	\thispagestyle{empty}
        \cleardoublepage
	
        \thispagestyle{empty}     % No number page, headings...
       % \include{tfg_soft_hard}
	...
	%\include{tfg_frontmatter_intro}
	%\include{tfg_main_020}
	%\include{tfg_main_030}
