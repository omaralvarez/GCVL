...
\begin{itemize}
	...
	\item \textbf{OpenCL\_platform:} Helper class that aids in the creation of a certain computing platform. AMD, NVIDIA, Intel, etc.
	\item \textbf{OpenCL\_platforms\_list:} Class that holds a list with all the available platforms in the system.
	\item \textbf{OpenCL\_device:} Utility class that aids in the creation of compute devices.
	\item \textbf{OpenCL\_devices\_list:} Class that holds a list of all the compute devices available in a platform and tries to guess the best one.
	\item \textbf{OpenCL\_Kernel:} Wrapper class for the creation of kernels in OpenCL.
	\item \textbf{OpenCL\_Array:} Helper class for OpenCL device array creation.
	\item \textbf{OpenCL\_Data:} Utility class for the creation of OpenCL device data.
\end{itemize}
...
\begin{itemize}
	...
	\item \textbf{CUDA\_device:} Utility class that aids in the instantiation of compute devices.
	\item \textbf{CUDA\_devices\_list:} Class that holds a list of all the compute devices available in the system. In addition, it tries to guess the best one depending on architecture, compute units and clock speed.
	\item \textbf{CUDA\_Array:} Helper class for OpenCL device array creation.
\end{itemize}
